...
Again, the plot showcases time on the x-axis, and the average number of service breaks per match on the y-axis. Users can customize the plot by selecting different surfaces (e.g. clay, grass, etc.).
