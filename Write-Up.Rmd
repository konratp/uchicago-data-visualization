...
q2_p1 <- participate_sex %>% 
 ...
 scale_color_manual(name = "Proportion of",
  ...
  theme_minimal()
bg_theme <- theme(plot.title = element_text(face = "bold", size = rel(1.2)),
...
top_15 <- medalist_rank %>%
  ...
  #scale_color_manual(name='Types of medals',
   #                  breaks=c('Gold', 'Silver', 'Bronze'),
    #                 values=c('Gold'='#D6AF36', 'Silver'='#A7A7AD', 'Bronze'='#824A02')) +
q2_p2 <- top_15 %>%
  ...
  annotate("text", label = "Types of medals", x = 800, y = "GBR", size = rel(2.2)) +
